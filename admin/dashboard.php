                        ...
                        <a href="manage-ads.php">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <i class="mdi mdi-chart-areaspline widget-one-icon"></i>
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="Statistics">Manage Ads</p>
                                        <?php $query = mysqli_query($con, "select * from ads where status='A'");
                                        $countcat = mysqli_num_rows($query);
                                        ?>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    ...
                                    <div class="wigdet-one-content">
                                        ...
                                        <?php $query = mysqli_query($con, "select * from tblposts where status='D'");
                                        $countposts = mysqli_num_rows($query);
                                        ?>
                                        <h2><?php echo htmlentities($countposts); ?> <small></small></h2>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    ...
                                    <div class="wigdet-one-content">
                                        ...
                                        <?php $query = mysqli_query($con, "select * from users where userType != 'A'");
                                        $countposts = mysqli_num_rows($query);
                                        ?>
                                        <h2><?php echo htmlentities($countposts); ?> <small></small></h2>

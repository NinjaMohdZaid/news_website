...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            $imgnewfile = time()."_".md5($imgfile) . $extension;
            // Code for move image into directory
            move_uploaded_file($_FILES["postimage"]["tmp_name"], "postimages/" . $imgnewfile);
            $query = mysqli_query($con, "insert into tblposts(CategoryId,PostUrl,PostImage,user_id,status) values('$catid','$url','$imgnewfile','$user_id','$status')");
...
?>
    ...
    <head>
        ...
        <!-- App title -->
        <title>In360 News | Add News Article</title>

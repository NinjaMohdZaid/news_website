...
if(isset($_POST['login']))
  {
    ...
    $sql =mysqli_query($con,"SELECT * FROM users WHERE username='$uname' AND password='$password' AND (userType = 'A' OR userType = 'M' OR userType = 'P')");
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>In 360 News | Admin Panel</title>
